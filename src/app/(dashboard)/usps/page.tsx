...
export default function USPsCMSPage() {
  ...
  const handleToggleStatus = async (item: USPItem) => {
    try {
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmDialog
        ...
        title="Hapus Point Keunggulan (USP)?"
        description="Apakah Anda yakin ingin menghapus point keunggulan ini?"
        confirmText="Hapus USP"
        loading={deleting}
